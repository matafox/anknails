...
чтобы обсудить детали и оформить оплату удобным способом.  
...
щоб обговорити деталі та оформити оплату у зручний спосіб. 
...
`,
    ...
    },
    {
      ...
      answer:
        i18n.language === "ru"
          ? "Да. После успешного прохождения курса вы получите именной сертификат в PDF-формате, подтверждающий завершение курса."
          : "Так. Після успішного проходження курсу ви отримаєте іменний сертифікат у форматі PDF, що підтверджує завершення курсу.",
    },
  ];
