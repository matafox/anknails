      ...
      <div className="w-full max-w-4xl px-6">
        <div className="bg-white/50 dark:bg-neutral-900/40 backdrop-blur-2xl border border-pink-200/40 dark:border-neutral-700 rounded-2xl shadow-md overflow-hidden transition-all duration-300">
          ...
          >
            {t(
              "faq_payment_answer",
              "Після натискання кнопки «Купити курс» ти перейдеш на сторінку безпечної оплати. Ми приймаємо банківські картки Visa або Mastercard. Після успішної оплати отримаєш миттєвий доступ до уроків і лист із підтвердженням."
            )}
          </div>
        </div>
      </div>
