...
export default function Header() {
  ...
  const [scrolled, setScrolled] = useState(false); // 👈 стан скролу
  ...
  if (isAbout) {
    return (
      <header
        className={`fixed top-0 right-0 left-0 z-50 flex flex-wrap justify-end items-center gap-2 p-4 transition-all duration-300 
