...
<div className="relative z-20 h-full flex flex-col justify-between px-6 py-8 text-slate-900 dark:text-fuchsia-50">
  ...
  <div className="mt-auto mb-4">
    <p className="ank-login-floating-text text-lg font-semibold leading-snug">
      {t(
        "Структурований курс з поступовим переходом від основ до впевненого майстра",
        "Структурированный курс с плавным переходом от базы до уверенного мастера"
      )}
    </p>
    <p className="mt-3 text-xs opacity-80 max-w-xs">
      {t(
        "Увійдіть у кабінет, продовжуйте навчання з того місця, де зупинилися: доступ до всіх уроків, оновлень і матеріалів з одного акаунта.",
        "Войдите в кабинет и продолжайте обучение с того места, где остановились: доступ ко всем урокам, обновлениям и материалам из одного аккаунта."
      )}
    </p>
  </div>
</div>
